    ...
    <div align="center">
      <table border="0" class="tabel" cellspacing="1" width="98%" >
       <tr>
          ...
          <form action="pendaftaran_pencarian.php" method="post">          
        <th class="judul" colspan="11"><div align="right"><input type="text" name="nama_pasien" class="cari" size="25" size="40" placeholder="Masukkan Nama" />
&nbsp;&nbsp;
</th></div>
         </form></tr>
       
        <tr>
          <th class="judul2" colspan="11"><div align="center">Laporan Data Pendaftaran</div></th>
    </tr>
        <tr>
...
$nomor=1;
        ...
        <tr class="isiform1" bgcolor=<?php echo "$bgcolor"; ?>>
          <td height="44" class="isiform1"><div align="center"><?php echo $nomor;?></span></td>
    <td class="isiform1"><div align="left"><em>
      ...
      <td class="isiform1"><div align="center"><em><?php echo " <a href=pendaftaran_edit.php?no_pendaftaran=$data[no_pendaftaran]><img src='edit.png' width='30px' height='30px' /> </a>";?></em></div></td>
      <td class="isiform1"><div align="center"><em><?php echo "<a href=pendaftaran_delete.php?no_pendaftaran=$data[no_pendaftaran]&&hapus=oke><img src='delete.png' width='30px' height='30px' /></a>";?></em></div></td>
