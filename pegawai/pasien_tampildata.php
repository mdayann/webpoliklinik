<link rel="stylesheet" href="tabel.css" type="text/css" />
  ...
  &nbsp;&nbsp;
        ...
        <tr>
          <th class="isiform"><div align="center">Nomor</div></th>
...
$query = mysql_query("select*from pasien ")or die(mysql_error);
      ...
      <td class="isiform1"><div align="center"><em><?php echo "<a href=pasien_edit.php?no_pasien=$data[no_pasien]><img src='../img/edit.png' width='30px' height='30px'/></a>";?></em></div></td>
      <td class="isiform1"><div align="center"><em><?php echo "<a href=pasien_delete.php?no_pasien=$data[no_pasien]&&hapus=oke><img src='../img/delete.png' width='30px' height='30px'/></a>";?></em></div></td>
       <td class="isiform1"><div align="center"><em><?php echo "<a href=kartupeserta.php?no_pasien=$data[no_pasien]><img src='../img/print.png' width='30px' height='30px'' /></a>";?></em></div></td>
    </tr>   <?php $nomor++;}?>
      </table>
</div>
