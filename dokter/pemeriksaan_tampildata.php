...
$nomor=1;
  ...
  <tr class="isiform1" bgcolor=<?php echo "$bgcolor"; ?>>
    ...
    <td width="3%" class="isiform1"><em><?php echo "<a href=pemeriksaan_edit.php?no_pemeriksaan=$data[no_pemeriksaan]>
				<img src='../img/edit.png' width='30px' height='30px'/></a>";?></em></td>
    <td width="3%" class="isiform1"><em><?php echo "<a href=pemeriksaan_delete.php?no_pemeriksaan=$data[no_pemeriksaan]&&hapus=oke><img src='../img/delete.png' width='30px' height='30px'/></a>";?></em></td>
  	<td width="4%" class="isiform1"><em><?php echo "<a href=buktipemeriksaan.php?no_pendaftaran=$data[no_pendaftaran]><img src='../img/print.png' width='30px' height='30px' /></a>";?></em></td>
  </tr>
 <?php $nomor++;}?>
</table>
<p>&nbsp;</p>
