...
<table border="0" cellspacing="1" class="tabel" width="98%" >
  <tr>
    <form action="jadwal_praktek_pencarian.php" method="post">
      <th colspan="8" class="judul" > <div align="right">
  <input type="text" name="hari" class="cari" size="25"placeholder="Masukkan Nama Hari" />
  &nbsp;&nbsp;
  ...
  <?php
				include ("koneksi.php");
     		$query = mysql_query("select jadwal_praktek.*,dokter.* from jadwal_praktek,dokter where dokter.kode_dokter=jadwal_praktek.kode_dokter")or die(mysql_error);
				$nomor=1;
